import darts.src.darts.legacy_pipeline
from darts.src.darts.legacy_pipeline.s2_fast import LegacyNativeSentinel2PipelineFast
...
if __name__ == "__main__":
    ...
    try:
        # darts.src.darts.legacy_pipeline.run_native_sentinel2_pipeline_fast(pipeline=sentinel_2_pipeline)
