...
def search_s2_stac(
    ...
    Args:
        intersects (Any): An area of interest, must implement the __geo_interface__ protocol.
...
@stopwatch.f("Searching for Sentinel 2 tiles via STAC from AOI", printer=logger.debug)
